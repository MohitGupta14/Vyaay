  ...
  return (
    <div className="w-64 min-h-screen bg-navbar p-5 flex flex-col">
      <nav className="flex flex-col gap-4">
        <Link
          href="/"
          className="text-white hover:bg-gray-700 p-2 font-bold text-4xl mb-6 rounded"
        >
          𝘝𝘺𝘢𝘢𝘺
        </Link>
        <Link
        ...
        <div className="relative">
          ...
          {/* Animate dropdown */}
          <div
            className={`absolute left-0 w-full bg-white text-black rounded shadow-lg transition-all duration-300 ease-in-out ${
              isDropdownOpen ? "max-h-60 overflow-y-auto" : "max-h-0"
            }`}
